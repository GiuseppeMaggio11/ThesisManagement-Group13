      ...
      (element) => (
        {
          ...
          notes: element.notes,
          expiration: element.expiration ? element.expiration : "",
...
const API = { logIn, logOut, getUserInfo, getThesisProposals, applicationThesis, getThesisProposalsById, sendFiles };
export default API;
